...
public final class HddsConfigKeys {
  ...
  public static final String HDDS_X509_GRACE_DURATION_TOKEN_CHECKS =
      "hdds.x509.grace.duration.token.checks";
  public static final boolean HDDS_X509_GRACE_DURATION_TOKEN_CHECKS_DEFAULT =
      true;
